...
describe(`Local testing of generated playwright scripts`, () => {
    ...
    test('Local testing of the Login use case', async () => {
        ...
        const browser = await chromium.launch({headless: false, slowMo: 400, devtools: true})
        const context = await browser.newContext()
        await context.addCookies([{
            name: 'user',
            value: '29f23fdb-f2ea-4bb0-8860-7b98d7917d4f',
        ...
        await page.click('a#login2.nav-link[href="#"][data-toggle="modal"][data-target="#logInModal"][style="display: block;"]');
        await page.mouse.move(997, 33);
        await page.mouse.move(789, 102);
        await page.mouse.move(750, 115);
        await page.mouse.move(572, 165);
        await page.click('input#loginusername.form-control[type="text"]');
        ...
        await page.click('button.btn.btn-primary[type="button"][onclick="logIn()"]');
        await page.waitForTimeout(10000)
        await browser.close()
    })

    test('Local testing of the login use case with mouse up/down and key up/down', async () => {
